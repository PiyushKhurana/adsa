...
class FibonacciHeapNode {
    ...
    public FibonacciHeapNode(int key,String p,int v) {
        this.key = key;
        this.degree = 0;
        this.mark = false;
        this.parent = null;
...
public class FibonacciHeap {
    ...
    public void insert(int key,String psf,int vertex) {
        FibonacciHeapNode node = new FibonacciHeapNode(key,psf,vertex);
        if (minNode != null) {
